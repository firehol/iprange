...
func TestKVManySetsOneRebuildAndFileEmptyReturnsV40(t *testing.T) {
	...
	// The freed KV/scope-table pages are now on the persisted free-list, so the file may
	// be v4.2 (free_list_head != 0) rather than byte-compatible v4.0. The contract is "no

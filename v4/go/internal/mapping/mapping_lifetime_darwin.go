...
// immutable open waits for a writer holding the exclusive lock, retrying
// the wait on EINTR exactly like the linux peer.
...
// for the writer to release it before mapping.

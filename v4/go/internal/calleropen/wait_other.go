...
// Sleep is the platform fallback: Windows carries no fd-table poller
// hazard (the I/O completion port allocates no descriptor and no
// eventfd), so the runtime timer path is safe there and time.Sleep keeps
// the sharpest wake-up available.

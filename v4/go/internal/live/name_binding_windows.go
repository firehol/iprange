...
// formed (Rust validate_windows_utf16le): even byte length and no
// zero, slash, or backslash units. Publication names are ASCII
// components, so the surrogate-pair walk of the Rust arm cannot fire;
// the unit checks stay for defense in depth.

...
func HousekeepingArtifactJSON(value *iprangedb.HousekeepingArtifact) map[string]any {
	...
	result := map[string]any{
		...
		"envelope_basename":          artifactBasename(value.EnvelopeBasename, value.BasenameEncoding),
		"envelope_identity":          FileIdentityJSONOrError(&value.EnvelopeIdentity),
		"source_basename":            artifactBasename(value.SourceBasename, value.BasenameEncoding),
		"inert_basename":             artifactBasename(value.InertBasename, value.BasenameEncoding),

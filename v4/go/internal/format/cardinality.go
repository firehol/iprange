...
// ErrCardinalityOverflow reports an exact cardinality above 2^129-1.
var ErrCardinalityOverflow = errors.New("cardinality overflow")

// Cardinality129 is an exact unsigned value in 0..=2^129-1
// (binary-format-v4.md section 17). This implementation is a verified
// transfer of the scalar arithmetic from the reviewed old Go tree
// (internal/exactv4/cardinality.go), whose behavior was checked against the
// spec before reuse.
...
// Bit128 returns the bit-128 limb (0 or 1).
func (c Cardinality129) Bit128() uint8 { return c.bit128 }

// Hi returns the high 64-bit limb.
func (c Cardinality129) Hi() uint64 { return c.hi }

// Lo returns the low 64-bit limb.

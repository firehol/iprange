...
`6606f4d4…`, Rust product `14112702…` at the wave-15 astra
round-3 repair revision `2e4f184d`; the worker and fixture
identities are build-proven there as well).  The wave-13 role-round delta found the Rust EOF arm

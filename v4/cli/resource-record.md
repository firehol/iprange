...
`9e78de86…`, Rust product `73cb0626…` at the wave-15 role-delta
revision `13a1982e`; the worker and fixture identities are
build-proven there as well).  The wave-13 role-round delta found the Rust EOF arm

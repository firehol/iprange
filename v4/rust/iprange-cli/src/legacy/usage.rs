//! Exact `--help` text of the released legacy CLI (copied verbatim
//! from `src/iprange.c` `usage()`; `%s` is the program name).

pub const USAGE: &str = r#"iprange manages IP ranges

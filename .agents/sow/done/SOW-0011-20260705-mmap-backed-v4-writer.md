...
acceptance criteria and follow-ups are not claimed completed; all still-valid work
was consolidated into SOW-0016 under the user's final v4 decisions.

Historical sub-state: Implementation repaired after round-19 review fixes. Both `create` and

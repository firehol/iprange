...
This SOW is retained as historical performance evidence only. Its unfinished
acceptance criteria and follow-ups are not claimed completed; the still-binding
explicit-validation rule and all remaining work were consolidated into SOW-0016.

Historical sub-state: Phase 0 (static fixes) starting 2026-07-06. All user decisions recorded.
...
Decisions recorded:
- D1: New SOW-0013 for this independent performance work.
...
1. **D1 — SOW scope**: New SOW-0013. **Selected: A.**
   Reasoning: separate workloads in separate SOWs give cleaner data.

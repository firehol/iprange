...
(11,634 lines) plus a trimmed shell harness (552 lines) whose 535-case
durable battery (463 rejections, 72 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 535/535 mutation forms rejected (463 rejections, 72
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 535 cases (463 rejections, 72 benign acceptances)
  ...
  unlistable module). Gate totals: 11,634 (tool) + 552 (shell) = 12,186

...
(12,744 lines) plus a trimmed shell harness (552 lines) whose 577-case
durable battery (494 rejections, 83 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): all 577 mutation cases pass their expectations
(494 rejections, 83 benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 577 cases (494 rejections, 83 benign acceptances)
  ...
  unlistable module). Gate totals: 12,744 (tool) + 552 (shell) = 13,296

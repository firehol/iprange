...
(10,695 lines) plus a trimmed shell harness (552 lines) whose 507-case
durable battery (437 rejections, 70 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 507/507 mutation forms rejected (437 rejections, 70
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 507 cases (437 rejections, 70 benign acceptances)
  ...
  unlistable module). Gate totals: 10,695 (tool) + 552 (shell) = 11,247

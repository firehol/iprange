...
(12,199 lines) plus a trimmed shell harness (552 lines) whose 556-case
durable battery (480 rejections, 76 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 556/556 mutation forms rejected (480 rejections, 76
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 556 cases (480 rejections, 76 benign acceptances)
  ...
  unlistable module). Gate totals: 12,199 (tool) + 552 (shell) = 12,751

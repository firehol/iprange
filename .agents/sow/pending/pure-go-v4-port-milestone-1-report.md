...
231); the self-test now durably rejects two hundred thirty-eight
...
the positional os.Root opener class, and round-52 forms 278-281
pin the embedded file-handle literal-launder class, the var-bound
generic-instantiation class, and the anonymous struct-literal
...
GOOS/GOARCH pairs): 238/238 mutation forms rejected (plus 50 benign controls)

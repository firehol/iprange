...
(12,679 lines) plus a trimmed shell harness (552 lines) whose 569-case
durable battery (490 rejections, 79 benign acceptances) includes the complete-page ownership forms and the
...
- Cross-compilation passes for linux amd64/386/arm/arm64/loong64, darwin
  ...
  gate's per-target listing matrix). Windows is an explicit honest
...
GOOS/GOARCH pairs): all 569 mutation cases pass their expectations
(490 rejections, 79 benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 569 cases (490 rejections, 79 benign acceptances)
  ...
  unlistable module). Gate totals: 12,679 (tool) + 552 (shell) = 13,231

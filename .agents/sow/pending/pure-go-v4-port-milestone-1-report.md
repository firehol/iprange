...
(12,067 lines) plus a trimmed shell harness (552 lines) whose 551-case
durable battery (477 rejections, 74 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 551/551 mutation forms rejected (477 rejections, 74
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 551 cases (477 rejections, 74 benign acceptances)
  ...
  unlistable module). Gate totals: 12,067 (tool) + 552 (shell) = 12,619

...
(12,003 lines) plus a trimmed shell harness (552 lines) whose 548-case
durable battery (475 rejections, 73 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 548/548 mutation forms rejected (475 rejections, 73
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 548 cases (475 rejections, 73 benign acceptances)
  ...
  unlistable module). Gate totals: 12,003 (tool) + 552 (shell) = 12,555

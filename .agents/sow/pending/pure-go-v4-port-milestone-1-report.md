...
(12,214 lines) plus a trimmed shell harness (552 lines) whose 559-case
durable battery (481 rejections, 78 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 559/559 mutation forms rejected (481 rejections, 78
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 559 cases (481 rejections, 78 benign acceptances)
  ...
  unlistable module). Gate totals: 12,214 (tool) + 552 (shell) = 12,766

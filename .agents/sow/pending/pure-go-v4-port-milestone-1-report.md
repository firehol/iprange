...
231); the self-test now durably rejects two hundred two
...
round-43 form 248, and round-45 forms 249-252 pin the dup/exec subprocess escape, the bodyless assembly-stub
...
Tee/Vmsplice/IoctlFileClone*/Clonefile*, and *os.Root laundering
through struct fields; details in the
...
GOOS/GOARCH pairs): 202/202 mutation forms rejected (plus 50 benign controls)
...
file-bearing type everywhere *os.File does, pinned as form 252. Decision 5A remains the single open item and

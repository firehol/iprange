...
(12,732 lines) plus a trimmed shell harness (552 lines) whose 576-case
durable battery (494 rejections, 82 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): all 576 mutation cases pass their expectations
(494 rejections, 82 benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 576 cases (494 rejections, 82 benign acceptances)
  ...
  unlistable module). Gate totals: 12,732 (tool) + 552 (shell) = 13,284

...
class (forms 121); the self-test now durably
rejects one hundred two mutation forms (details in the
...
(forms 116-119), and the pointer-defined-type class
(forms 121); the
self-test now durably rejects one hundred two mutation forms. Decision 5A remains the single open item and

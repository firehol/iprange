...
231); the self-test now durably rejects two hundred one
...
round-43 form 248, and round-45 forms 249-251 pin the dup/exec subprocess escape, the bodyless assembly-stub
...
reaching stream wrappers, and the x/sys descriptor-transfer primitives
Tee/Vmsplice/IoctlFileClone*/Clonefile*; details in the
...
GOOS/GOARCH pairs): 201/201 mutation forms rejected (plus 50 benign controls)

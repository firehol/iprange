...
(11,916 lines) plus a trimmed shell harness (552 lines) whose 544-case
durable battery (472 rejections, 72 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): 544/544 mutation forms rejected (472 rejections, 72
benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 544 cases (472 rejections, 72 benign acceptances)
  ...
  unlistable module). Gate totals: 11,916 (tool) + 552 (shell) = 12,468

...
(12,728 lines) plus a trimmed shell harness (552 lines) whose 575-case
durable battery (493 rejections, 82 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): all 575 mutation cases pass their expectations
(493 rejections, 82 benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 575 cases (493 rejections, 82 benign acceptances)
  ...
  unlistable module). Gate totals: 12,728 (tool) + 552 (shell) = 13,280

...
(12,447 lines) plus a trimmed shell harness (552 lines) whose 566-case
durable battery (487 rejections, 79 benign acceptances) includes the complete-page ownership forms and the
...
GOOS/GOARCH pairs): all 566 mutation cases pass their expectations
(487 rejections, 79 benign acceptances)
...
- Gate replacement: v4/go-gate is a type-aware scanner over go/types
  ...
  data inside the tool: 566 cases (487 rejections, 79 benign acceptances)
  ...
  unlistable module). Gate totals: 12,447 (tool) + 552 (shell) = 12,999

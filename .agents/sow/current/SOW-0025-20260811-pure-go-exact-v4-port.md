...
round-25 entry below. The durable battery is 562 cases (483 rejections,
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (562 cases: 483 rejections, 79 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 562-case battery, and the SOW audit.
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 562-form `--self-test`

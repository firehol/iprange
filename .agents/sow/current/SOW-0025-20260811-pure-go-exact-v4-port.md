...
mmap gate is an 12,186-line typed toolchain (11,634-line go/types module
...
round-25 entry below. The durable battery is 535 cases (463 rejections,
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (535 cases: 463 rejections, 72 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 535-case battery, and the SOW audit.
...
lines; gate tooling 12,186 raw lines total (11,634 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 535-form `--self-test`

...
mmap gate is an 12,751-line typed toolchain (12,199-line go/types module
...
round-25 entry below. The durable battery is 556 cases (480 rejections,
76 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (556 cases: 480 rejections, 76 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 556-case battery, and the SOW audit.
...
lines; gate tooling 12,751 raw lines total (12,199 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 556-form `--self-test`

...
mmap gate is an 12,766-line typed toolchain (12,214-line go/types module
...
round-25 entry below. The durable battery is 559 cases (481 rejections,
78 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (559 cases: 481 rejections, 78 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 559-case battery, and the SOW audit.
...
lines; gate tooling 12,766 raw lines total (12,214 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 559-form `--self-test`

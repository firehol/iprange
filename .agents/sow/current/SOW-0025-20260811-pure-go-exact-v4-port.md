...
mmap gate is an 13,280-line typed toolchain (12,728-line go/types module
...
round-25 entry below. The durable battery is 575 cases (493 rejections,
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (575 cases: 493 rejections, 82 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 575-case battery, and the SOW audit.
...
lines; gate tooling 13,280 raw lines total (12,728 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 575-form `--self-test`

...
mmap gate is an 12,555-line typed toolchain (12,003-line go/types module
...
round-25 entry below. The durable battery is 548 cases (475 rejections,
73 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (548 cases: 475 rejections, 73 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 548-case battery, and the SOW audit.
...
lines; gate tooling 12,555 raw lines total (12,003 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 548-form `--self-test`

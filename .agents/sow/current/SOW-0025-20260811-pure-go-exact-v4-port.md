...
mmap gate is an 13,284-line typed toolchain (12,732-line go/types module
...
round-25 entry below. The durable battery is 576 cases (494 rejections,
82 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (576 cases: 494 rejections, 82 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 576-case battery, and the SOW audit.
...
lines; gate tooling 13,284 raw lines total (12,732 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 576-form `--self-test`

...
mmap gate is an 12,999-line typed toolchain (12,447-line go/types module
...
round-25 entry below. The durable battery is 566 cases (487 rejections,
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (566 cases: 487 rejections, 79 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 566-case battery, and the SOW audit.
...
lines; gate tooling 12,999 raw lines total (12,447 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 566-form `--self-test`

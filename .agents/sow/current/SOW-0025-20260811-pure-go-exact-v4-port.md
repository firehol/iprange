...
mmap gate is an 12,468-line typed toolchain (11,916-line go/types module
...
round-25 entry below. The durable battery is 544 cases (472 rejections,
72 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (544 cases: 472 rejections, 72 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 544-case battery, and the SOW audit.
...
lines; gate tooling 12,468 raw lines total (11,916 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 544-form `--self-test`

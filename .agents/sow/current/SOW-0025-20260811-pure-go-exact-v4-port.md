...
mmap gate is an 13,269-line typed toolchain (12,717-line go/types module
...
round-25 entry below. The durable battery is 573 cases (492 rejections,
81 benign acceptances) plus 9 shell environment mutations and passes end
to end.
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (573 cases: 492 rejections, 81 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 573-case battery, and the SOW audit.
...
lines; gate tooling 13,269 raw lines total (12,717 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 573-form `--self-test`

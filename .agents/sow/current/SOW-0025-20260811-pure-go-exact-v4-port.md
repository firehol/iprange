...
mmap gate is an 13,273-line typed toolchain (12,721-line go/types module
...
round-25 entry below. The durable battery is 574 cases (492 rejections,
...
- P1 enforcement - fixed: the type-light 4,738-line AST taint engine and
  ...
  (574 cases: 492 rejections, 82 benign); the shell harness keeps only the import-boundary, module-graph,
...
the import-graph gate with its 574-case battery, and the SOW audit.
...
lines; gate tooling 13,273 raw lines total (12,721 go-gate + 552 shell). Hot-path benchmarks on the
...
- `./check-import-graph.sh` — passes; the content-transfer scan is the typed
  ...
  exempted as exact, file-taint-verified shapes; the 574-form `--self-test`
